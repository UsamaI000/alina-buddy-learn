    ...
    const texts = {
      de: {
        hero: {
          ...
          description:
            "ALINA unterstützt Auszubildende mit personalisierten Lernpfaden, mehrsprachigem Support und intelligenter Prüfungsvorbereitung.",
          cta: "Jetzt starten",
          demo: "Demo ansehen",
        },
        features: {
      ...
      en: {
        hero: {
          ...
          description:
            "ALINA supports apprentices with personalized learning paths, multilingual support and intelligent exam preparation.",
          cta: "Get Started",
          demo: "Watch Demo",
        },
        features: {
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative overflow-hidden bg-gradient-hero text-primary-foreground">
        <div className="absolute inset-0">
          <img src={heroImage} alt="ALINA Learning Platform" className="w-full h-full object-cover opacity-20" />
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8 animate-float">
              <div>
                ...
                <h1 className="text-4xl lg:text-6xl font-bold mb-6 leading-tight">{t.hero.title}</h1>
                <p className="text-xl lg:text-2xl mb-4 text-primary-foreground/90">{t.hero.subtitle}</p>
                <p className="text-lg text-primary-foreground/80 leading-relaxed">{t.hero.description}</p>
              </div>
              ...
              <Card className="bg-white/10 border-white/20 backdrop-blur-sm shadow-large">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="bg-primary/20 rounded-lg p-4 ml-8">
                    <p className="text-white/90 text-sm">"Erkläre mir bitte das Vierventil-System"</p>
                  </div>
                  <div className="bg-white/10 rounded-lg p-4">
                    <p className="text-white/90 text-sm">
      ...
      <section className="py-24 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-4xl font-bold text-foreground mb-6">{t.features.title}</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <Card
                key={index}
                className="shadow-soft hover:shadow-medium transition-smooth border-0 bg-gradient-to-br from-card to-muted/30"
              >
                <CardHeader>
      ...
      <section className="py-24 bg-muted/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-4xl font-bold text-foreground mb-6">{t.benefits.title}</h2>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <Card className="shadow-medium border-0">
              <CardHeader className="bg-gradient-primary text-primary-foreground rounded-t-lg">
                <CardTitle className="text-2xl text-center">👨‍🎓 {t.benefits.students}</CardTitle>
              </CardHeader>
            ...
            <Card className="shadow-medium border-0">
              <CardHeader className="bg-gradient-secondary text-secondary-foreground rounded-t-lg">
                <CardTitle className="text-2xl text-center">👨‍🏫 {t.benefits.instructors}</CardTitle>
              </CardHeader>
              <CardContent className="p-8">
                <ul className="space-y-4">
      ...
      <section className="py-24 bg-gradient-hero text-primary-foreground">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl mb-8 text-primary-foreground/90">{t.cta.description}</p>
      ...
      <footer className="bg-card border-t py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-muted-foreground mb-4">Adaptiver Lernassistent für intelligente Nachwuchsausbildung</p>
