...
-- RLS Policies for learning_modules (public read, instructors manage)
...
-- RLS Policies for tasks (users own data + instructors see all)
...
-- RLS Policies for events (users own data + instructors see all)
